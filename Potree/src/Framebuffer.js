 ...
 * When invoking the constructor with "system", the framebuffer will refer to the system/default framebuffer.
 * 
 * @param {int} width
 * @param {int} height
 ...
 * 
 * @param {[x,y]} start x and y must be values between 0 and 1
 * @param {[x,y]} end x and y must be values between 0 and 1
 */
...
Framebuffer.prototype.checkBuffer = function checkBuffer(){
    ...
    switch (status) {
        ...
        case gl.FRAMEBUFFER_INCOMPLETE_ATTACHMENT:
        	Logger.error("Incomplete framebuffer: FRAMEBUFFER_INCOMPLETE_ATTACHMENT");
        	throw "";
            break;
        case gl.FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT:
        	Logger.error("Incomplete framebuffer: FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT");
        	throw "";
            break;
        case gl.FRAMEBUFFER_INCOMPLETE_DIMENSIONS:
        	Logger.error("Incomplete framebuffer: FRAMEBUFFER_INCOMPLETE_DIMENSIONS");
        	throw "";
            break;
